...
However, for this specific case we can use the convenience function `fwa_gnis_streams` and `fwa_search_gnis_streams` to find a valid gnis_name. We use the `columns` argument to get the `blue_line_key` column along with the geometry. 
```{r}
